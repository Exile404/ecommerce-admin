...
export default function Products(){
    ...
    return (
        <Layout>
            <Link className="bg-blue-900 text-white rounded-md text-white py-1 px-2" href={'/products/new'}>
                Add new procduct
            </Link>
            <table className="basic mt-2">
                ...
                <tbody>
                    {procducts.map(procduct => (
                        <tr>
                            <td>{procduct.title}</td>
                            <td>
                                <Link href={'/products/edit/'+procduct._id}>
